    ...
    >
      <motion.div variants={itemVariants}>
        ...
        <p className="text-zinc-500 dark:text-zinc-400">
          Selamat datang kembali, <span className="font-medium text-zinc-900 dark:text-zinc-300">{user?.customer_name || "Guest"}</span>. Berikut adalah ringkasan dompet digital Anda.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 tablet:grid-cols-2 desktop:grid-cols-3 gap-6">
        <motion.div variants={itemVariants}>
          <Card className="border-zinc-200 dark:border-zinc-800 shadow-sm relative overflow-hidden bg-white dark:bg-zinc-950">
            ...
            <CardContent>
              <div className="text-4xl tablet:text-5xl font-bold tracking-tight text-zinc-900 dark:text-white">
                {formattedBalance}
              </div>
            </CardContent>
          </Card>
      ...
      <motion.div variants={itemVariants} className="space-y-4">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Link href="/dashboard/transfer">
            <Button variant="outline" className="h-12 px-6 border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors shadow-sm bg-transparent">
